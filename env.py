...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        img_obstacle1 = Image.open("F:/MASA KULIAH\KULIAH/tugas/SM 6/STUDI INDEPENDEN/minggu kesembilan/RL/QL/images/road_closed1.png")
        self.obstacle1_object = ImageTk.PhotoImage(img_obstacle1)
        # Obstacle type 2 - tree1
        img_obstacle2 = Image.open("F:/MASA KULIAH\KULIAH/tugas/SM 6/STUDI INDEPENDEN/minggu kesembilan/RL/QL/images/tree1.png")
        self.obstacle2_object = ImageTk.PhotoImage(img_obstacle2)
        # Obstacle type 3 - tree2
        img_obstacle3 = Image.open("F:/MASA KULIAH\KULIAH/tugas/SM 6/STUDI INDEPENDEN/minggu kesembilan/RL/QL/images/tree2.png")
        self.obstacle3_object = ImageTk.PhotoImage(img_obstacle3)
        # Obstacle type 4 - building1
        img_obstacle4 = Image.open("F:/MASA KULIAH\KULIAH/tugas/SM 6/STUDI INDEPENDEN/minggu kesembilan/RL/QL/images/building1.png")
        self.obstacle4_object = ImageTk.PhotoImage(img_obstacle4)
        # Obstacle type 5 - building2
        img_obstacle5 = Image.open("F:/MASA KULIAH\KULIAH/tugas/SM 6/STUDI INDEPENDEN/minggu kesembilan/RL/QL/images/building2.png")
        self.obstacle5_object = ImageTk.PhotoImage(img_obstacle5)
        # Obstacle type 6 - road closed2
        img_obstacle6 = Image.open("F:/MASA KULIAH\KULIAH/tugas/SM 6/STUDI INDEPENDEN/minggu kesembilan/RL/QL/images/road_closed2.png")
        self.obstacle6_object = ImageTk.PhotoImage(img_obstacle6)
        # Obstacle type 7 - road closed3
        img_obstacle7 = Image.open("F:/MASA KULIAH\KULIAH/tugas/SM 6/STUDI INDEPENDEN/minggu kesembilan/RL/QL/images/road_closed3.png")
        self.obstacle7_object = ImageTk.PhotoImage(img_obstacle7)
        # Obstacle type 8 - traffic lights
        img_obstacle8 = Image.open("F:/MASA KULIAH\KULIAH/tugas/SM 6/STUDI INDEPENDEN/minggu kesembilan/RL/QL/images/traffic_lights.png")
        self.obstacle8_object = ImageTk.PhotoImage(img_obstacle8)
        # Obstacle type 9 - pedestrian
        img_obstacle9 = Image.open("F:/MASA KULIAH\KULIAH/tugas/SM 6/STUDI INDEPENDEN/minggu kesembilan/RL/QL/images/pedestrian.png")
        self.obstacle9_object = ImageTk.PhotoImage(img_obstacle9)
        # Obstacle type 10 - shop
        img_obstacle10 = Image.open("F:/MASA KULIAH\KULIAH/tugas/SM 6/STUDI INDEPENDEN/minggu kesembilan/RL/QL/images/shop.png")
        self.obstacle10_object = ImageTk.PhotoImage(img_obstacle10)
        # Obstacle type 11 - bank1
        img_obstacle11 = Image.open("F:/MASA KULIAH\KULIAH/tugas/SM 6/STUDI INDEPENDEN/minggu kesembilan/RL/QL/images/bank1.png")
        self.obstacle11_object = ImageTk.PhotoImage(img_obstacle11)
        # Obstacle type 12 - bank2
        img_obstacle12 = Image.open("F:/MASA KULIAH\KULIAH/tugas/SM 6/STUDI INDEPENDEN/minggu kesembilan/RL/QL/images/bank2.png")
        self.obstacle12_object = ImageTk.PhotoImage(img_obstacle12)

        # Creating obstacles themselves
        # Obstacles from 1 to 22
        self.obstacle1 = self.canvas_widget.create_image(pixels * 4, pixels * 5, anchor='nw', image=self.obstacle2_object)
        # Obstacle 2
        ...
        # Final Point
        img_flag = Image.open("F:/MASA KULIAH\KULIAH/tugas/SM 6/STUDI INDEPENDEN/minggu kesembilan/RL/QL/images/flag.png")
        ...
        img_robot = Image.open("F:/MASA KULIAH\KULIAH/tugas/SM 6/STUDI INDEPENDEN/minggu kesembilan/RL/QL/images/agent1.png")
